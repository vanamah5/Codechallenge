...
public class CustomerDaoImpl implements CustomerDao{
	...
	public boolean saveCustomer(Customer customer) {
		String SQL_INSERT_Customer = "insert into Customer(id, name, city, state, Ref_No) values(?,?,?,?,?)";
	...
	public boolean updateCustomer(Customer customer) {
		String SQL_UPDATE_Customer = "update Customer set name = ?, city = ?, state  = ?, Ref_No=? where id = ?";
